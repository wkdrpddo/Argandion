...
public class BuildingChange : MonoBehaviour
{
    ...
    public void BuildStart()
    {
        ...
        // 표지판 만들기
        _makeSign.makeSign(gameObject.transform.position.x, gameObject.transform.parent.position.y, gameObject.transform.position.z - floor.GetComponent<BoxCollider>().size.z * floor.transform.localScale.z / 2, _constructionSet.transform, _makeFences._icon, false);
